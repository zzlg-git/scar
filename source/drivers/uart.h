...
// Definition
#define UART_CHAN_PTR   UART3_BASE_PTR
#define UART_CHANNEL    (3)              // pin144: 0-5 is available pin100: 0-4

#define UART_TX_PCR     PORTC_PCR17  // uart port
#define UART_TX_ATLn    (3) // 0-7
#define UART_RX_PCR     PORTC_PCR16
